...
public class UserAnswerController {
    ...
    @PostMapping(value = "user-answer", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<UserAnswerResponseDTO> updateUserAnswer(@RequestBody UserAnswerUpdateDTO updateDTO) {
        return ResponseEntity.ok(userAnswerService.update(updateDTO));
    }
